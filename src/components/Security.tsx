...
export function Security() {
  return (
    <section id="security" className="relative overflow-hidden">
      {/* Fade-in strip: light to dark (matches Testimonial purple family) */}
      <div className="h-24 bg-gradient-to-b from-cream to-[#2A2660]" />

      <div className="relative py-20 lg:py-28">
        {/* Dark gradient -- same purple family as Testimonial for visual consistency */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#2A2660] via-[#1E1B4B] to-[#1a1844]" />
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-forest/30 to-forest-light/10 rounded-2xl flex items-center justify-center mb-6 ring-1 ring-white/[0.08]">
                    <Icon size={26} className="text-sage/80" strokeWidth={1.7} />
                  </div>
      ...
      <div className="h-24 bg-gradient-to-b from-[#1a1844] to-cream" />
    </section>
  )
}
